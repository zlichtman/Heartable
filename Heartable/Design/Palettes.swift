...
// EverForest dark, medium contrast: https://github.com/sainnhe/everforest/blob/master/palette.md
private let _everforestTheme = ThemeDef(
    key: "everforest", label: "EverForest", group: .dark,
    section: "Dark", subtitle: "sage + warm cream", logoColor: Color(hex: 0xa7c080),
    palette: Palette(
        bg: Color(hex: 0x2d353b), bgElevated: Color(hex: 0x343f44),
        surface: Color(hex: 0x3d484d), card: Color(hex: 0x343f44),
        cardHover: Color(hex: 0x3d484d),
        border: Color(hex: 0x859289, alpha: 0.22), borderHover: Color(hex: 0x9da9a0, alpha: 0.38),
        text: Color(hex: 0xd3c6aa), textSecondary: Color(hex: 0x9da9a0),
        textMuted: Color(hex: 0x859289),
        rose: Color(hex: 0xa7c080), roseDim: Color(hex: 0xa7c080, alpha: 0.14),
        roseGlow: Color(hex: 0xa7c080, alpha: 0.26),
        violet: Color(hex: 0xd699b6), amber: Color(hex: 0xdbbc7f),
        emerald: Color(hex: 0x83c092), sky: Color(hex: 0x7fbbb3),
        danger: Color(hex: 0xe67e80), dangerDim: Color(hex: 0xe67e80, alpha: 0.16),
        grad1: Color(hex: 0xa7c080), grad2: Color(hex: 0x83c092), grad3: Color(hex: 0x7fbbb3),
        cream: Color(hex: 0xd3c6aa), playerBackdrop: Color(hex: 0x232a2e),
        visualizer: [Color(hex: 0xa7c080), Color(hex: 0x83c092), Color(hex: 0x7fbbb3)]
    ),
    curated: true, curatedSection: "Dark"
)
